...
public class DBManagerTest {
    ...
    public void testLoad() {
        ...
        for (int i = 0; i < referencePairs.size(); i++) {
            ...
            Assert.assertEquals(referencePlayers.get(0).getPlayerID(), savedPlayers.get(0).getPlayerID());
            Assert.assertEquals(referencePlayers.get(0).getName(), savedPlayers.get(0).getName());

            Assert.assertEquals(referencePlayers.get(1).getPlayerID(), savedPlayers.get(1).getPlayerID());
